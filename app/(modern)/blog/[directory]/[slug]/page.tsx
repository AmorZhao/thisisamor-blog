      ...
      <main className="w-full p-8">
        <article className="prose mx-auto">
          <div className="markdown-body">
            {diaryData ? (
              <div>
                <div className="flex items-center space-x-8 mt-2 mb-2 ml-2 text-sm text-grey-500 dark:text-grey-350 y2k:text-y2k-light-grey dark:y2k:text-y2k-dark-grey">
        ...
        <article className="prose mx-auto">
          {postData ? (
            <div>
              ...
              <div className="markdown-body">
                <hr />
                <div className="flex items-center space-x-8 mt-2 mb-2 text-sm text-grey-500 dark:text-grey-350 y2k:text-y2k-light-grey dark:y2k:text-y2k-dark-grey">
                  <p>
                ...
                <p className="text-grey-500 dark:text-grey-350 y2k:text-y2k-light-grey dark:y2k:text-y2k-dark-grey ml-1">Description: {postData.description}</p>
                <hr />
                <br />
                <Markdown
                  remarkPlugins={[remarkGfm, remarkMath]}
