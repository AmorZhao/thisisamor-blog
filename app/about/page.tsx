    ...
    <div>
      ...
      <div className="flex flex-1">
        <main className="p-8 font-noto">
          <h1 className="text-2xl font-noto-semibold mb-4">About Amor | 关于阿漠</h1>
          <div>
            ...
            <br />
            <h2 className="text-xl font-noto-semibold mb-4">About This Site | 关于本页</h2>
              <div>
                <p className="mb-2">
              ...
              <hr className="custom-border"/>
              <br />
            <h2 className="text-xl font-noto-semibold mb-4">Amor&apos;s Friends | 阿漠的友链</h2>
              <p className="mb-2">
